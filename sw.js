...
const {
    ...
    return [() => {
        ...
        const a = e();
        return n.set(o, a), [o, a.promise]
    }, (e, t, s) => {
        const o = n.get(e);
        n.delete(e), s ? o?.reject(s) : o?.resolve(t)
    }]
})(), o = e => new Response(`[${e.join(",")}]`), a = e => new Response(t(e)), {
    protocol: i,
    host: r,
    pathname: l
...
addEventListener("activate", e => e.waitUntil(clients.claim())), addEventListener("fetch", e => {
    ...
    "POST" === t.method && t.url === c && (e.stopImmediatePropagation(), e.respondWith(t.json().then(([e, t]) => {
        const [s, i] = n();
        return d.postMessage([s, e, t]), i.then(o, a)
    }, a)))
